...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_DrumSet p_DrumSet;
        ...
        public static SteamVR_Input_ActionSet_DrumSet DrumSet
        {
            get
            {
                return SteamVR_Actions.p_DrumSet.GetCopy<SteamVR_Input_ActionSet_DrumSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_DrumSet = ((SteamVR_Input_ActionSet_DrumSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_DrumSet>("/actions/DrumSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.DrumSet};
        }
    }
}
